...
NN_FRAMEWORK.Cart = function() {
    ...
    if (isExist($(".themgiohang"))) {
        $("body").on("click", ".themgiohang", function () {
            ...
            var linkhinh = $(this).parents(".box-product").find(".pic-product img").attr("data-src");
            var parent = $(this).parents(".box-product");
            var cart = $(document).find(".cart-fixed");
            $("<img />", {class: "fly-to-cart",src: linkhinh,}).appendTo("body").css({
...
NN_FRAMEWORK.SlickPage = function() {
    ...
    if (isExist($(".slick-taisaochon"))) {
        $(".slick-taisaochon").slick({
            dots: false,
            infinite: true,
            autoplaySpeed: 3000,
            slidesToShow: 6,
