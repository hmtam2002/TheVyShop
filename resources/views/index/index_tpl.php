                            ...
                            <p class="pic-dichvu m-0 rounded-circle overflow-hidden">
                                <a class="scale-img" href="<?= $v[$sluglang] ?>" title="<?= $v['name' . $lang] ?>">
                                    <img class="lazy w-100"
                                        onerror="this.src='<?= THUMBS ?>/155x155x1/assets/images/noimage.png';"
                                        data-src="<?= THUMBS ?>/155x155x1/<?= UPLOAD_NEWS_L . $v['photo'] ?>"
        ...
        <div class="wrap-content">
            <div class="owl-page owl-carousel owl-theme" data-xsm-items="2:5" data-sm-items="2:5" data-md-items="3:10"
                ...
                <div class="item-tieuchi">
                    <p class="pic-tieuchi">
                        <img class="lazy w-100" onerror="this.src='<?= THUMBS ?>/453x290x1/assets/images/noimage.png';"
                            data-src="<?= THUMBS ?>/453x290x1/<?= UPLOAD_NEWS_L . $v['photo'] ?>"
                            alt="<?= $v['name' . $lang] ?>" title="<?= $v['name' . $lang] ?>" />
                    </p>
        ...
        <div class="gioithieu-box d-flex flex-wrap">
            <div class="pic-gioithieu d-flex justify-content-lg-between">
                <div class="big-pic scale-img">
                    <img class="lazy w-100" onerror="this.src='<?= THUMBS ?>/450x447x1/assets/images/noimage.png';"
                        data-src="<?= THUMBS ?>/450x447x1/<?= UPLOAD_NEWS_L . $gioithieu['photo'] ?>"
                        alt="<?= $gioithieu['name' . $lang] ?>" title="<?= $gioithieu['name' . $lang] ?>" />
                </div>
                <div class="small-pic scale-img">
                    <img class="lazy w-100" onerror="this.src='<?= THUMBS ?>/283x320x1/assets/images/noimage.png';"
                        data-src="<?= THUMBS ?>/283x320x1/<?= UPLOAD_NEWS_L . $gioithieu['photo1'] ?>"
                        alt="<?= $gioithieu['name' . $lang] ?>" title="<?= $gioithieu['name' . $lang] ?>" />
                </div>
            </div>
    ...
    <div class="wrap-tieuchi padding-top-bottom">
        <div class="owl-page owl-carousel owl-theme" data-xsm-items="1:0" data-sm-items="1:0" data-md-items="1:0"
            ...
            <div class="banner-pic">
                <a href="">
                    <img class="lazy w-100" onerror="this.src='<?= THUMBS ?>/1366x300x1/assets/images/noimage.png';"
                        data-src="<?= THUMBS ?>/1366x300x1/<?= UPLOAD_PHOTO_L . $v['photo'] ?>"
                        alt="<?= $v['name' . $lang] ?>" title="<?= $v['name' . $lang] ?>" />
                </a>
