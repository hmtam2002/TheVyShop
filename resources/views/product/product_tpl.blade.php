...
<?php if (\Request::getRequestUri() == 'tim-kiem') { ?>
    <div class="div_kq_search mb-4"><?= $titleMain ?> (<?= $total ?>): <span>"<?php echo $keywordText; ?>"</span></div>
<?php } ?>
                ...
                <div class="col-6 col-sm-6 col-md-4 col-lg-3 mg-cus mb-3">
                    <div class="box-product" data-aos="fade-up" data-aos-duration="1000">
                        <div class="pic-product">
                            <a class="text-decoration-none scale-img" href="{{ route('chitiet', $v->slugvi) }}" title="<?= $v['name' . $lang] ?>">
                                <img class="lazy w-100" src="{{ asset('watermark/product/285x285x2/upload/product/'. $v['photo'] )}}" alt="<?= $v['name' . $lang] ?>" title="<?= $v['name' . $lang] ?>" style="opacity: 1;" />
                            </a>
                            <div class="product-tool d-flex align-items-stretch justify-content-between transition mb-0">
                                <a class="product-detail-view text-decoration-none text-hover-main transition" href="{{ route('chitiet', $v->slugvi) }}" title="<?= xemchitiet ?>">
                                ...
                                <a class="product-quick-view text-decoration-none text-hover-main transition" data-slug="{{ route('chitiet', $v->slugvi) }}" title="<?=xemnhanh?>">
                        ...
                        <h3 class="mb-0"><a class="text-decoration-none text-split name-product" href="{{ route('chitiet', $v->slugvi) }}" title="<?= $v['name' . $lang] ?>"><?= $v['name' . $lang] ?></a></h3>
