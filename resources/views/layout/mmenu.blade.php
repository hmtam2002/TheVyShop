...
<div class="header-logo-reponsive">
 ...
 <div class="menu-res">
     <div class="menu-bar-res">
         ...
         <!-- <div class="search-res">
             ...
             <div class="search-grid w-clear">
                 <input type="text" name="keyword-res" id="keyword-res" placeholder="Nhập từ khóa tìm kiếm..." onkeypress="doEnter(event,'keyword-res');" value="<?= (!empty($_GET['keyword-res'])) ? $_GET['keyword-res'] : '' ?>" />
     ...
     <nav id="menu">
         <ul>
             <li><a class="<?php if (\Request::getRequestUri() == '' || \Request::getRequestUri() == 'index') echo 'active'; ?> transition" href="" title="<?= trangchu ?>"><?= trangchu ?></a></li>
             <li><a class="<?php if (\Request::getRequestUri() == 'gioi-thieu') echo 'active'; ?> transition" href="gioi-thieu" title="<?= gioithieu ?>"><?= gioithieu ?></a></li>
            <li>
                            <a class="<?php if (\Request::getRequestUri() == 'dich-vu') echo 'active'; ?> transition" href="dich-vu" title="<?= dichvu ?>">Dịch Vụ In</a>
             ...
             <li>
                 <a class="<?php if (\Request::getRequestUri() == 'san-pham') echo 'active'; ?> transition" href="san-pham" title="<?= sanpham ?>">Mẫu Sản Phẩm</a>
             ...
             <li>
                 <a class="has-child <?php if (\Request::getRequestUri() == 'tin-tuc') echo 'active'; ?> transition" href="tin-tuc" title="<?= tintuc ?>"><?= tintuc ?></a>
             ...
             <li><a class="<?php if (\Request::getRequestUri() == 'lien-he') echo 'active'; ?> transition" href="lien-he" title="<?= lienhe ?>"><?= lienhe ?></a></li>
         </ul>
     </nav>
 </div>