            ...
            <a class="slideshow-image" href="<?= $v['link'] ?>" target="_blank" title="<?= $v['name' . $lang] ?>">
                <picture>
                    <source media="(max-width: 500px)"
                        srcset="{{ asset('thumbs/500x200x1/upload/photo/'.$v->photo) }}">
                    <img class="lazy w-100" onerror="this.src='{{ asset("thumbs/1366x600x1/assets/images/noimage.png") }}';"
                        data-src="{{ asset('thumbs/500x200x1/upload/photo/'.$v->photo) }}"
