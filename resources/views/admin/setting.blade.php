                    ...
                    <div class="card card-primary card-outline text-sm">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <button type="button" class="btn btn-database bg-gradient-success"
                                    data-action="OPTIMIZE"><i class="fas fa-magic mr-2"></i>Optimize</button>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 col-sm-6">
                                        ...
                                        <input type="text" class="form-control text-sm" name="data[options][email_host]"
                                            id="email_host" placeholder="Email host" value="">
                                    </div>
                                    <div class="form-group col-md-4 col-sm-6">
                                        ...
                                        <input type="text" class="form-control text-sm"
                                            ...
                                            placeholder="Password host" value="">
                                    </div>
                                </div>
                            </div>
                            <div class="gmail-email ">
                                <div class="row">
                                    <div class="form-group col-md-4 col-sm-6">
                                        ...
                                        <input type="text" class="form-control text-sm"
                                            name="data[options][host_gmail]" id="host_gmail" placeholder="Host"
                                            value="">
                                    </div>
                                    <div class="form-group col-md-4 col-sm-6">
                                        <label for="port_gmail">Port:</label>
                                        <input type="text" class="form-control text-sm"
                                            name="data[options][port_gmail]" id="port_gmail" placeholder="Port"
                                            value="">
                                    </div>
                                    <div class="form-group col-md-4 col-sm-6">
                                        <label for="secure_gmail">Secure:</label>
                                        <select class="custom-select text-sm" name="data[options][secure_gmail]"
                                            id="secure_gmail">
                                            <option value="tls">
                                                TLS</option>
                                            <option value="ssl">
                                    ...
                                    <div class="form-group col-md-4 col-sm-6">
                                        ...
                                        <input type="text" class="form-control text-sm"
                                            name="data[options][email_gmail]" id="email_gmail" placeholder="Email"
                                            value="">
                                    </div>
                                    <div class="form-group col-md-4 col-sm-6">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control text-sm" name="data[options][coords_iframe]" id="coords_iframe" rows="5"
                                    placeholder="Tọa độ google map iframe"></textarea>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control text-sm" name="data[headjs]" id="headjs" rows="5" placeholder="Head JS"></textarea>
                            </div>
                            <div class="form-group">
                                <label for="bodyjs">Body JS:</label>
                                <textarea class="form-control text-sm" name="data[bodyjs]" id="bodyjs" rows="5" placeholder="Body JS"></textarea>
                            </div>
                            <div class="card card-primary card-outline card-outline-tabs">
                                <div class="card-header p-0 border-bottom-0">
                                    <ul class="nav nav-tabs" id="custom-tabs-three-tab-lang" role="tablist">
                                        <li class="nav-item">
                                            <a class="nav-link" id="tabs-lang" data-toggle="pill" href="#tabs-lang-vi"
                                                role="tab" aria-controls="tabs-lang-vi" aria-selected="true"></a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-body card-article">
                                    <div class="tab-content" id="custom-tabs-three-tabContent-lang">
                                        <div class="tab-pane fade show" id="tabs-lang-vi" role="tabpanel"
                                            aria-labelledby="tabs-lang">
                                            <div class="form-group">
                                                <label for="name">Tiêu đề gì đó:</label>
                                                <input type="text" class="form-control for-seo text-sm"
                                                    name="data[name]" id="name" placeholder="Tiêu đề (gì đó)"
                                                    value="" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="adress">Địa chỉ (gì đó):</label>
                                                <input type="text" class="form-control text-sm" name="data[address]"
                                                    id="address" placeholder="Địa chỉ ()" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
