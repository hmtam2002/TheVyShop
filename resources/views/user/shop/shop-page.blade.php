                            ...
                            <div class="product-image">
                                ...
                                <a href="#">
                                    ...
                                    <img class="primary blur-up lazyload"
                                        ...
                                        src="{{ asseTt('assets/images/product-images/product-image4.jpg') }}"
                                        alt="image" title="product" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                            ...
                            <div class="product-image">
                                ...
                                <a href="#">
                                    ...
                                    <img class="primary blur-up lazyload"
                                        ...
                                        src="assets/images/product-images/product-image26.jpg" alt="image"
                                        title="product" />
                                    <!-- End image -->
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                            ...
                            <div class="product-image">
                                ...
                                <a href="#">
                                    ...
                                    <img class="hover blur-up lazyload"
                                        ...
                                        src="assets/images/product-images/product-image28-1.jpg" alt="image"
                                        title="product" />
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
                        ...
                        <div class="col-6 col-sm-6 col-md-4 col-lg-4 item">
                            ...
                            <div class="product-image">
                                ...
                                <a href="#">
                                    ...
                                    <!-- Hover image -->
                                    <img class="hover blur-up lazyload"
                                        data-src="{{ asset('assets/images/product-images/product-image31-1.jpg') }}s"
                                        src="{{ asset('assets/images/product-images/product-image31-1.jpg') }}s" alt="image"
                                        title="product" />
                                    <!-- End hover image -->
                                </a>
                                <!-- end product image -->
