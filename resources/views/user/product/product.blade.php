                ...
                <div class="zoompro-wrap product-zoom-right pl-20">
                    <div class="zoompro-span">
                        <img class="blur-up lazyload zoompro"
                            data-zoom-image="{{ asset('assets/images/product-detail-page/cape-dress-1.jpg') }}"
                            alt="" src="{{ asset('assets/images/product-detail-page/cape-dress-1.jpg') }}" />
                    </div>
              ...
              ></a>
                ...
                <div class="product-thumb product-thumb-1">
                    <div id="gallery" class="product-dec-slider-1 product-tab-left">
                        <a data-image="{{ asset('assets/images/product-detail-page/cape-dress-1.jpg') }}"
                            data-zoom-image="{{ asset('assets/images/product-detail-page/cape-dress-1.jpg') }}"
                            class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                            <img class="blur-up lazyload" src="assets/images/product-detail-page/cape-dress-1.jpg"
                                alt="" />
                        </a>
                        <a data-image="{{ asset('assets/images/product-detail-page/cape-dress-2.jpg') }}"
                            ...
                            class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1">
                            <img class="blur-up lazyload" src="assets/images/product-detail-page/cape-dress-2.jpg"
                                alt="" />
                        </a>
                        <a data-image="{{ asset('assets/images/product-detail-page/cape-dress-3.jpg') }}"
                            ...
                            <img class="blur-up lazyload" src="assets/images/product-detail-page/cape-dress-3.jpg"
                                alt="" />
                        </a>
                        <a data-image="{{ asset('assets/images/product-detail-page/cape-dress-4.jpg') }}"
                            ...
                            class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1">
                            <img class="blur-up lazyload" src="assets/images/product-detail-page/cape-dress-4.jpg"
                                alt="" />
                        </a>
                        <a data-image="{{ asset('assets/images/product-detail-page/cape-dress-5.jpg') }}"
                            ...
                            class="slick-slide slick-cloned" data-slick-index="0" aria-hidden="true" tabindex="-1">
                            <img class="blur-up lazyload" src="assets/images/product-detail-page/cape-dress-5.jpg"
                                alt="" />
                        </a>
                        <a data-image="{{ asset('assets/images/product-detail-page/cape-dress-6.jpg') }}"
                            ...
                            class="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true" tabindex="-1">
                            <img class="blur-up lazyload" src="assets/images/product-detail-page/cape-dress-6.jpg"
                                alt="" />
                        </a>
                        <a data-image="{{ asset('assets/images/product-detail-page/cape-dress-7.jpg') }}"
                            ...
                            class="slick-slide slick-cloned" data-slick-index="2" aria-hidden="true" tabindex="-1">
                            <img class="blur-up lazyload" src="assets/images/product-detail-page/cape-dress-7.jpg"
                                alt="" />
                        </a>
                        <a data-image="{{ asset('') }}" data-zoom-image="{{ asset('') }}"
                            class="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" tabindex="-1">
                            <img class="blur-up lazyload" src="assets/images/product-detail-page/cape-dress-8.jpg"
                                alt="" />
                        </a>
                    </div>
                </div>
            ...
            <div class="product-single__meta">
                ...
                <div class="prInfoRow">
                    ...
                    <div class="product-review">
                        <a class="reviewLink" href="#tab2"><i class="font-13 fa fa-star"></i><i
                                ...
                                class="spr-badge-caption">6 reviews</span></a>
                    </div>
                </div>
                        ...
                        <div class="product-form__item">
                            ...
                            <div data-value="Dark Green" class="swatch-element color dark-green available">
                                <input class="swatchInput" id="swatch-0-dark-green" type="radio" name="option-0"
                                    value="Dark Green" /><label class="swatchLbl color small"
        ...
        <div class="productPageSlider">
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image1-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image1-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                        <!-- product label -->
            ...
            <div class="col-12 item">
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image2.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image2-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image2-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                    </a>
                    <!-- end product image -->
                ...
                <div class="product-details text-center">
                    ...
                    <ul class="swatches">
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant2-1.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant2-2.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant2-3.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant2-4.jpg') }}" alt="image" />
                        </li>
                    </ul>
                    <!-- End Variant -->
                </div>
            ...
            <div class="col-12 item">
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image3.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image3-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image3-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                        <!-- product label -->
                        <div class="product-labels rectangular">
                ...
                <div class="product-details text-center">
                    ...
                    <ul class="swatches">
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant3-1.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant3-2.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant3-3.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant3-4.jpg') }}" alt="image" />
                        </li>
                    </ul>
                    <!-- End Variant -->
                </div>
            ...
            <div class="col-12 item">
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image4.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image4-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image4-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                        <!-- product label -->
                        <div class="product-labels">
                ...
                <div class="product-details text-center">
                    ...
                    <ul class="swatches">
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant4-1.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant4-2.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant4-3.jpg') }}" alt="image" />
                        </li>
                        <li class="swatch medium rounded">
                            <img src="{{ asset('assets/images/product-images/variant4-4.jpg') }}" alt="image" />
                        </li>
                    </ul>
                    <!-- End Variant -->
                </div>
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image5.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image5-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image5-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                        <!-- product label -->
                        <div class="product-labels">
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image7.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image7-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image7-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                    </a>
                    <!-- end product image -->
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image8.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image8-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image8-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                    </a>
                    <!-- end product image -->
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image9.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image9-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image9-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                    </a>
                    <!-- end product image -->
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image10.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image10-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image10-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                    </a>
                    <!-- end product image -->
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image13.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image13-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image13-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                    </a>
                    <!-- end product image -->
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image14.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image14-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image14-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                    </a>
                    <!-- end product image -->
                ...
                <div class="product-image">
                    ...
                    <a href="#">
                        ...
                        <img class="primary blur-up lazyload"
                            ...
                            src="{{ asset('assets/images/product-images/product-image15.jpg') }}" alt="image"
                            title="product" />
                        <!-- End image -->
                        <!-- Hover image -->
                        <img class="hover blur-up lazyload"
                            data-src="{{ asset('assets/images/product-images/product-image15-1.jpg') }}"
                            src="{{ asset('assets/images/product-images/product-image15-1.jpg') }}" alt="image"
                            title="product" />
                        <!-- End hover image -->
                    </a>
                    <!-- end product image -->
